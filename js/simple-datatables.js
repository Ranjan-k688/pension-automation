                        ...
                        (function () {
                            ...
                            var e = t(function (t, e) {
                                    t.exports = (function () {
                                        var t = "millisecond",
                                            ...
                                            M = {
                                                ...
                                                p: function (h) {
                                                    return (
                                                        { M: a, y: u, w: s, d: i, D: f, h: r, m: n, s: e, ms: t, Q: o }[h] ||
                                                        String(h || "")
                                                            .toLowerCase()
                                                            .replace(/s$/, "")
                                                    );
                                        ...
                                        var y = (function () {
                                                ...
                                                return (
                                                    ...
                                                    (l.diff = function (t, f, h) {
                                                        ...
                                                        return (
                                                            (m =
                                                                ((c = {}), (c[u] = m / 12), (c[a] = m), (c[o] = m / 3), (c[s] = ($ - M) / 6048e5), (c[i] = ($ - M) / 864e5), (c[r] = $ / 36e5), (c[n] = $ / 6e4), (c[e] = $ / 1e3), c)[d] || $),
                                                            h ? m : p.a(m)
                                                        );
                                                    }),
                                ...
                                n = t(function (t, e) {
                                    ...
                                    t.exports =
                                        ((n = { LTS: "h:mm:ss A", LT: "h:mm A", L: "MM/DD/YYYY", LL: "MMMM D, YYYY", LLL: "MMMM D, YYYY h:mm A", LLLL: "dddd, MMMM D, YYYY h:mm A" }),
                                        (r = function (t, e) {
                                            return t.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g, function (t, r, i) {
                                                ...
                                                return (
                                                    ...
                                                    e[i] ||
                                                    n[i] ||
                                                    e[s].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g, function (t, e, n) {
                                                        return e || n.slice(1);
                                                    })
                                                );
                                            });
                ...
                function (require, module, exports) {
                            ...
                            Promise.all(p).then((n) => {
                                ...
                                Array.from(h).forEach((e) => {
                                    ...
                                    (i = p ? p(a) : "string" == typeof a ? a.replace(/(\$|,|\s|%)/g, "") : a),
                                        parseFloat(i) == i ? (r[d++] = { value: Number(i), row: e }) : (l[o++] = { value: "string" == typeof a ? a.toLowerCase() : a, row: e });
                                }),
                    ...
                    const l = function (t) {
                        ...
                        r = {
                            ...
                            hiddenHeader: !1,
                            footer: !1,
                            labels: { placeholder: "Search...", perPage: "{select} per page", noRows: "No entries found", info: "Showing {start} to {end} of {rows} entries" },
                    ...
                    class o {
                        constructor(t, e = {}) {
                            if (
                                ((this.initialized = !1),
                                (this.options = { ...r, ...e, layout: { ...r.layout, ...e.layout }, labels: { ...r.labels, ...e.labels } }),
                        ...
                        render(t) {
                            ...
                            if (
                                ...
                                this.body || ((this.body = e("tbody")), this.table.appendChild(this.body)),
                            ...
                            if (
                                ...
                                s.footer ? this.head && !this.foot && ((this.foot = e("tfoot", { html: this.head.innerHTML })), this.table.appendChild(this.foot)) : this.foot && this.table.removeChild(this.table.tFoot),
                        ...
                        renderPage() {
                            ...
                            let t,
                                ...
                                i = 0;
                            if (
                                (this.totalPages && ((e = this.currentPage - 1), (a = e * this.options.perPage), (i = a + this.pages[e].length), (a += 1), (t = this.searching ? this.searchData.length : this.data.length)),
                        ...
                        fixColumns() {
                            if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
                                ...
                                if (((this.columnWidths = []), this.table.tHead)) {
                                    if (
                                        (this.options.scrollY.length && ((s = e("thead")), s.appendChild(e("tr")), (s.style.height = "0px"), this.headerTable && (this.table.tHead = this.headerTable.tHead)),
                        ...
                        import(e) {
                            ...
                            if (a.data.length || t(a.data)) {
                                if ("csv" === a.type) {
                                    ...
                                    t.length &&
                                        (a.headings && ((s.headings = t[0].split(a.columnDelimiter)), t.shift()),
                                        t.forEach((t, e) => {
                                            s.data[e] = [];
