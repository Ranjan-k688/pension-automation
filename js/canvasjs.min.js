/* 
 CanvasJS Chart - v3.10.0 Beta 1 - https://canvasjs.com/ 
...
!1}function ib(d){if(d._menuButton)d.exportEnabled?(Q(d._menuButton,{backgroundColor:d.toolbar.itemBackgroundColor,color:d.toolbar.fontColor}),La(d._menuButton),sa(d,d._menuButton,"menu"),0>=navigator.userAgent.search("MSIE")&&d._menuButton.childNodes[0]&&Q(d._menuButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"})):wa(d._menuButton);else if(d.exportEnabled&&v){var m=!1;d._menuButton=document.createElement("button");sa(d,d._menuButton,"menu");d._toolBar.appendChild(d._menuButton);
...
"px solid "+this.toolbar.buttonBorderColor,backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor}),sa(this,this._zoomButton,"zoom"),0>=navigator.userAgent.search("MSIE")&&this._zoomButton.childNodes[0]&&Q(this._zoomButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"});else{var c=!1;wa(this._zoomButton=document.createElement("button"));sa(this,this._zoomButton,"pan");this._toolBar.appendChild(this._zoomButton);this._zoomButton.style.borderRight=this.toolbar.buttonBorderThickness+
"px solid "+this.toolbar.buttonBorderColor;H(this._zoomButton,"touchstart",function(a){c=!0},this.allDOMEventHandlers);H(this._zoomButton,"click",function(){a.zoomEnabled?(a.zoomEnabled=!1,a.panEnabled=!0,sa(a,a._zoomButton,"zoom")):(a.zoomEnabled=!0,a.panEnabled=!1,sa(a,a._zoomButton,"pan"));a.render()},this.allDOMEventHandlers);H(this._zoomButton,"mousemove",function(){c?c=!1:(Q(a._zoomButton,{backgroundColor:a.toolbar.itemBackgroundColorOnHover,color:a.toolbar.fontColorOnHover,transition:"0.4s",
WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&Q(a._zoomButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},this.allDOMEventHandlers);H(this._zoomButton,"mouseout",function(){c||(Q(a._zoomButton,{backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&Q(a._zoomButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},this.allDOMEventHandlers)}this._resetButton?
(Q(this._resetButton,{borderRight:this.toolbar.buttonBorderThickness+"px solid "+this.toolbar.buttonBorderColor,backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor}),0>=navigator.userAgent.search("MSIE")&&this._resetButton.childNodes[0]&&Q(this._resetButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}),this._resetButton.title=this._cultureInfo.resetText):(c=!1,wa(this._resetButton=document.createElement("button")),sa(this,this._resetButton,"reset"),this._resetButton.style.borderRight=
...
this._zoomButton&&(this.panEnabled?sa(a,a._zoomButton,"zoom"):sa(a,a._zoomButton,"pan"),a._resetButton.getAttribute("state")!==a._cultureInfo.resetText&&sa(a,a._resetButton,"reset"));this.options.toolTip&&this.toolTip.options!==this.options.toolTip&&(this.toolTip.options=this.options.toolTip);for(g in this.toolTip.options)this.toolTip.options.hasOwnProperty(g)&&this.toolTip.updateOption(g)};m.prototype._updateSize=function(){var a;a=[this.canvas,this.overlaidCanvas,this._eventManager.ghostCanvas];
...
z.lineDashType,O=1===Math.round(N)%2?0.5:0,P=z.upperBoxColor,pb=z.lowerBoxColor,ta=n(z.options.fillOpacity)?1:z.fillOpacity,R=z.dataPointIds[q];this._eventManager.objectMap[R]={id:R,objectType:"dataPoint",dataSeriesIndex:s,dataPointIndex:q,x1:C,y1:m,x2:D,y2:k,x3:d,y3:l,x4:d,y4:p,y5:r,borderThickness:A,color:e,stemThickness:ka,stemColor:oa,whiskerThickness:K,whiskerLength:Z,whiskerColor:J,lineThickness:N,lineColor:Q};c.save();0<ka&&(c.beginPath(),c.strokeStyle=oa,c.lineWidth=ka,c.setLineDash&&c.setLineDash(G(M,
ka)),c.moveTo(d-E,k),c.lineTo(d-E,m),c.stroke(),c.moveTo(d-E,p),c.lineTo(d-E,l),c.stroke());c.restore();b.lineWidth=Math.max(A,4);c.beginPath();ba(c,C,Math.min(r,k),D,Math.max(k,r),pb,0,e,w?B:!1,w?!1:B,!1,!1,ta);c.beginPath();ba(c,C,Math.min(l,r),D,Math.max(r,l),P,0,e,w?!1:B,w?B:!1,!1,!1,ta);c.beginPath();c.lineWidth=A;c.strokeStyle=e;c.rect(C-H,Math.min(k,l)-H,D-C+2*H,Math.max(k,l)-Math.min(k,l)+2*H);c.stroke();c.save();0<N&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(G(S,N)),c.strokeStyle=
...
2,d+e/2),c.stroke(),c.moveTo(a+e/2,d-e/2),c.lineTo(a-e/2,d+e/2),c.stroke())}},drawMarkers:function(a){for(var d=0;d<a.length;d++){var c=a[d];X.drawMarker(c.x,c.y,c.ctx,c.type,c.size,c.color,c.borderColor,c.borderThickness)}}};return m}();t.version="v3.10.0 Beta 1";window.CanvasJS&&(t&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=t)})();
